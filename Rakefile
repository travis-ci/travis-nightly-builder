...
RUNTIMES = {
  'perl' => OpenStruct.new(
    ...
    supported_major_minor: %w(5.24 5.26 5.27 5.28 5.29),
  ),
  'perl-extras' => OpenStruct.new(
    ...
    supported_major_minor: %w(5.24 5.26 5.28),
  ),
  ...
  'erlang' => OpenStruct.new(
    ...
    supported_major_minor: ['19.3', '20.0', '20.1', '20.2', '20.3', '21.0', '21.1', '21.2', '21.3', '22.0'],
